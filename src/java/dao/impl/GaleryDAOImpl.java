...
public class GaleryDAOImpl extends DBContext implements GaleryDAO {
     ...
     */
    @Override
    public List<Galery> getTop3Galery(int topNumber) throws Exception {
     ...
     */
    @Override
    public Galery getGaleryByID(int index, int id) throws Exception {
        Connection conn = null;
        PreparedStatement pr = null;
        ResultSet rs = null;
        try {
    ...
    public static void main(String[] args) {
        try {
            ...
            List<Galery> list = dao.getTop3Galery(3);
